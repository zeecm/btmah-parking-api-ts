...
var ThirdPartyParkingAPIClient = /** @class */ (function () {
    ...
    ThirdPartyParkingAPIClient.prototype.makeAPICall = function (endpoint, custom_headers, params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        final_endpoint = "".concat(endpoint, "?").concat(urlParams);
...
var URAParkingAPIClient = /** @class */ (function (_super) {
    ...
    URAParkingAPIClient.prototype._getToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                response = this._makeAPICallToGetToken().then(function (response) { return console.log(response); });
                return [2 /*return*/];
            });
        });
    };
    URAParkingAPIClient.prototype._makeAPICallToGetToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeAPICall(this._TOKEN_ENDPOINT, this._defaultHeaders)];
            });
        });
    };
